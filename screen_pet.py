...
pupil_left = c.create_oval(140, 145, 150, 155, outline='black', fill='blue')

eye_right = c.create_oval(230, 110, 260, 170, outline='black', fill='white')
pupil_right = c.create_oval(240, 145, 250, 155, outline='black', fill='blue')

mounth_normal = c.create_line(
    170, 250, 200, 272, 230, 250, smooth=1, width=2, state=NORMAL, fill='black')
mouth_happy = c.create_line(170, 250, 200, 282, 230,
                            250, smooth=1, width=2, state=HIDDEN, fill='black')
mouth_sad = c.create_line(170, 250, 200, 232, 230,
                          250, smooth=1, width=2, state=HIDDEN, fill='black')

cheek_left = c.create_oval(70, 180, 120, 230, outline='pink')
